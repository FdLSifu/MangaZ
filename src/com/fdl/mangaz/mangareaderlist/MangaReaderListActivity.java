...
import com.fdl.mangaz.MangaDescriptionActivity;
...
public class MangaReaderListActivity extends Activity implements OnItemClickListener, OnQueryTextListener{
	public ListView lv = null;
	public static ArrayAdapter<String> adapter = null;
	private MangaReaderListAsync mAsyncTask;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			mAsyncTask = new MangaReaderListAsync(this);
			mAsyncTask.execute("");
		}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		Intent intent = new Intent(this,MangaDescriptionActivity.class);
	...
	public boolean onQueryTextChange(String DynamicText) {
		// TODO Auto-generated method stub
		MangaReaderListActivity.adapter.getFilter().filter(DynamicText);
		return false;
	}
	...
	public boolean onQueryTextSubmit(String FinalText) {
		// TODO Auto-generated method stub
		MangaReaderListActivity.adapter.getFilter().filter(FinalText);
		return false;
	}
