...
public class MangaReaderAPI implements MangaEngine{
	...
	public static int nbChapters = 0;
	/**
	 * URLs
	 */
	public ArrayList<String>  pageURLs = new ArrayList<String>();
	...
	public String getDescription(String URL) throws IOException{
		...
		String description = el.first().text();
	...
	public void refreshLists(){
		...
		if (chapterNames.size() == chapterURLs.size())
			nbChapters = chapterNames.size();
	}
	...
	public void initializePageList() {
		...
		try {
			...
			for(int i = 0; i<items.size(); i++){
				this.pageURLs.add(items.get(i).absUrl("value"));
			}
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	 ...
	 */
	private ArrayList<String> initializeChapterList() {
